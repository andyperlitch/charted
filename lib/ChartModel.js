...
var ChartModel = Backbone.Model.extend({
    ...
    validate: function(attrs) {
        ...
        if (attrs.vp_width < 30 || attrs.vp_width > 2000) return "Viewport must have a reasonable width";
        
        if (attrs.vp_height < 30 || attrs.vp_height > 2000) return "Viewport must have a reasonable width";
    ...
    getYGuideInterval: function(num) {
        ...
        return this.get('vp_height') / ( num - 1);
    }
});
